...
export const NODE_MANAGER = 'Massa Node-manager';
...
// List of websites that are allowed to be added to favorites
export const FAVORITES_WEBSITES = ['flappy', 'psychedelic', 'flappynathana1'];
