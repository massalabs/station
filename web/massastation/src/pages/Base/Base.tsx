    ...
    <div className="flex items-center gap-4">
      ...
      <button
        ...
        className={`
          ...
          ${!STEP.previous 
          ? 'bg-gray-600 border border-gray-500 opacity-50 cursor-not-allowed' 
          : 'border border-[#2e374c] hover:opacity-80'
    }
        `}
        style={{
          backgroundColor: !STEP.previous ? '#6b7280' : '#030d23',
        }}
      >
      ...
      <button
        ...
        `}
        style={{
          backgroundColor: !STEP.next ? '#6b7280' : '#0043ff',
          borderColor: !STEP.next ? '#6b7280' : '#0043ff',
        }}
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white">
