...
export function ActiveNodeManager(props: NodeManagerPluginProps) {
  ...
  return (
    <>
      <div className="w-full h-full rounded-t-md relative overflow-hidden" style={{ backgroundColor: '#1a2332' }}>
      ...
      >
        ...
        <div className="w-full">
          <Button 
            ...
            customClass="bg-[#0043ff] hover:bg-[#0043ff]/80 text-[#00fe6d] border-[#0043ff] font-semibold w-full"
          >
            Launch
          </Button>
        </div>
    ...
    <>
      ...
      <div className="w-full h-full text-primary bg-secondary border-2 border-neutral/20 
        ...
        <div className="w-full px-4 py-2 mas-buttons lg:h-14 flex items-center justify-center relative z-10 mb-4">
          <p className="text-center text-[#00fe6d] font-medium">{`${title} is not installed`}</p>
        </div>
