...
function home({}: Props) {
    ...
    const pluginList = plugins.map((plugin) => {
        return (
            <button className="flex flex-wrap bg-slate-600 rounded-lg p-5 m-5 " key={plugin.name}>
                <div className="mx-auto">
                    <div className="tooltip" data-tip={plugin.description}>
                        <img
                            className="max-w-12 max-h-12 self-center bg-slate-800"
                    ...
                    <h1 className="text-xl font-bold text-center text-white">{plugin.name}</h1>
                </div>
            </button>
        );
    });
    ...
    return (
        <div className="p-3">
            ...
            <div className="flex">
                <div className="">
                    <p className="text-xl p-5 text-white">
                        Welcome to Thyra, the best way to manage your{" "}
                        <img
                            className="max-w-5 max-h-5 inline-flex"
                            src="https://s3.us-west-2.amazonaws.com/secure.notion-static.com/8f7fd86a-a417-4a0c-ae19-2f6d4c3212e1/massa_logomark.png?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=AKIAT73L2G45EIPT3X45%2F20230113%2Fus-west-2%2Fs3%2Faws4_request&X-Amz-Date=20230113T132953Z&X-Amz-Expires=86400&X-Amz-Signature=09450832b4c17520a7b91fc9e22e20473239f8c43dada436eb122a3af6068a50&X-Amz-SignedHeaders=host&response-content-disposition=filename%3D%22massa_logomark.png%22&x-id=GetObject"
                            alt="Massa Logo"
                        />{" "}
                        Tokens and Plugins.
                    </p>
            ...
            <div className="m-4 grid mx-auto w-fit grid-cols-2 rounded-lg sm:grid-cols-3">
                {pluginList}
            </div>
        </div>
    );
