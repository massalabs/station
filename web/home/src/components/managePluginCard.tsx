...
const ManagePluginCard = () => {
  const plus =  UIStore.useState(s => (s.theme == "light" ? plusSmall : PlusSmallWhite));
  return (
    <div         onClick={() => {
    ...
    <button>
      <img src={plus} alt="plusSmall" className="rounded-full w-16 h-16 mx-auto bg-bgCard hover:bg-hoverbgCard" />
