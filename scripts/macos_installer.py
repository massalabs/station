...
class MacOSInstaller(Installer):
    def __init__(self):
        ...
        if platform.machine() == "arm64":
            ...
            self.THYRA_WALLET_PLUGIN_URL = "https://github.com/massalabs/thyra-plugin-wallet/releases/download/v0.0.10/wallet-plugin_darwin-arm64.zip"
            self.THYRA_WALLET_BINARY_FILENAME = "wallet-plugin_darwin-arm64"
            self.THYRA_WALLET_ZIP_FILENAME = "wallet-plugin_darwin-arm64.zip"
            ...
            self.THYRA_WALLET_PLUGIN_URL = "https://github.com/massalabs/thyra-plugin-wallet/releases/download/v0.0.10/wallet-plugin_darwin-amd64.zip"
            self.THYRA_WALLET_BINARY_FILENAME = "wallet-plugin_darwin-amd64"
            self.THYRA_WALLET_ZIP_FILENAME = "wallet-plugin_darwin-amd64.zip"
        else:
