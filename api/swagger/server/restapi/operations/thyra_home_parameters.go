...
//
// swagger:parameters thyraHome
type ThyraHomeParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewThyraHomeParams() beforehand.
func (o *ThyraHomeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ThyraHomeParams) bindResource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
