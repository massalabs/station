...
//
// swagger:parameters thyraPluginManager
type ThyraPluginManagerParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewThyraPluginManagerParams() beforehand.
func (o *ThyraPluginManagerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ThyraPluginManagerParams) bindResource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
