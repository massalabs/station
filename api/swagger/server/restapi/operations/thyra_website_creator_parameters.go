...
//
// swagger:parameters thyraWebsiteCreator
type ThyraWebsiteCreatorParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewThyraWebsiteCreatorParams() beforehand.
func (o *ThyraWebsiteCreatorParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ThyraWebsiteCreatorParams) bindResource(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
