// Package certificate provides operations for handling certificates and private keys
// used in TLS (Transport Layer Security). It is especially geared towards dealing with
// entities encoded in the PEM (Privacy Enhanced Mail) format. These operations include
// loading and parsing PEM-encoded certificates and private keys from file paths.
//
// The package exposes:
