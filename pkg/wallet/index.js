...
function copyToClipboard(element) {
	navigator.clipboard.writeText(wallets[element.parentNode.parentNode.rowIndex - 1].address);
}

function deleteRow(element) {
	document.getElementById('user-wallet-table').deleteRow(element.parentNode.parentNode.rowIndex);
}
