	...
	<div class="container">
		...
		<div class="website-card">
			...
			<div class="website-line">
				...
				<div class="popover__wrapper-website">
					<a class="wallet_button" href="#">
						<h2 class="popover__title"></h2>
					</a>
					<div class="popover__content">
			...
			<div class="website-line">
				<h4 class="website-card-label">Website Name</h4> <input class="form-control" id="websiteName"
					name="websiteName" type="text" />
			</div>

			<div class="website-line" id="website-upload">
		...
		<div class='row justify-content-md-center align-items-center mt-5'>
			...
			<div class='col'>
				<button id="create-sc" onClick="setTxType('deployWebsiteCreator')" class="primary-button me-5"
					id='buttonid' type='button' value='Upload MB' data-bs-toggle="modal"
					data-bs-target="#passwordModal">Create SC</button>
