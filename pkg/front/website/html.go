...
// generated:  Thu Sep 29 11:37:03 CEST 2022
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="passwordModalLabel">Enter the password</h5>
		...
		<div class="website-centering">
			<div class="website-card">
				...
				<div class="website-line">
					...
					<div class="upload">
						<input class="website-file-input" onchange="validateSize(this)" type="file" accept=".zip" />
					</div>

					<h4 id="fileError" class="fileTypeError">File type needs to be .zip only</h4>
					<h4 id="fileError" class="fileSizeError">Max Zip size needs to be 1.5Mo</h4>
				</div>

				<button class="primary-button primary-button me-5 small-button" id="website-upload"
					onClick="setTxType('deployWebsiteAndUpload')" type="button" value="Upload MB" data-bs-toggle="modal"
					data-bs-target="#passwordModal">
					Deploy to massa blockchain
				</button>

				<button class="primary-button small-button" id="website-upload-refuse">Deploy to massa
					blockchain</button>
			</div>
		</div>
