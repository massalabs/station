...
// generated:  Wed Sep 28 20:01:45 CEST 2022
			...
			<div class="website-centering">
				<div class="website-card">
					...
					<div class="website-line">
						...
						<button class="primary-button small-button" id="file-select-button">Import From</button>
						<div class="upload">
					...
					<div class="align-right">
						<p id="website-info-display" class="website-info-display"><a href="https://github.com/massalabs/thyra#upload-a-website" target="_blank" class="website-info-display">Format info</a></p>
					</div>
					...
					<button class="primary-button small-button" id="website-upload-refuse">Deploy to massa blockchain</button>
				</div>
			</div>
