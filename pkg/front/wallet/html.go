...
// generated:  Mon Oct  3 14:00:30 CEST 2022
			...
			<div class="col-6">
				<div class="row mb-5">
					<div class="col">
						...
						<button id="import-wallet" class="primary-button" type="button" value="Upload MB">
							Load a wallet
						</button>
					</div>
				</div>
				...
				<div class="row">
					<div id="create-form">
						<h2 class="mb-4">Create a wallet</h2>

						<div class="form-floating mb-3 col-md-10">
							<input class="form-control" placeholder="Wallet name" id="nicknameCreate"
								name="nicknameCreate" type="text" />
							<label for="nicknameCreate">Wallet name</label>
						</div>
					...
					<div class="row mb-5">
						<div class="col">
							<button type="button" class="primary-button" onClick="createWallet()">
								Create
							</button>
						</div>
					</div>
