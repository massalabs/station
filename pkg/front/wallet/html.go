		...
		<nav class="navbar navbar-expand-lg navbar-dark">
			<div class="container">
				<a class="navbar-brand" href="#"
					><img src="./logo_banner.webp" class="massa-logo" alt="Massa logo"
				/></a>
				<h2>Thyra</h2>
				<button
			...
			<div class="row mt-5">
				<div class="col-6">
					...
					<div class="row">
						...
						<div class="row mb-5">
							<div class="col">
								<button type="button" class="primary-button" onClick="createWallet()">Create</button>
							</div>
						</div>
					</div>
				</div>
